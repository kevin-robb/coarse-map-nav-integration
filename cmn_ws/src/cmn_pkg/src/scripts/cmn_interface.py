...
class CoarseMapNavInterface():
    ...
    def __init__(self, config:CmnConfig, cmd_vel_pub, discrete_motion_pub):
        """
        ...
        @param discrete_motion_pub rospy publisher for Twist commands, which the motion planner will use to command motion.
        """
        ...
        if self.use_discrete_space:
            ...
            self.motion_planner.discrete_motion_pub = discrete_motion_pub
        else:
            self.motion_planner = MotionPlanner()
            self.motion_planner.cmd_vel_pub = cmd_vel_pub
        ...
        self.motion_planner.wait_for_motion_to_complete = not config.enable_sim
